...
with open("C:\\Users\\huzai\\OneDrive\\Desktop\\12feb\\secret.key", 'rb') as key_file:
    key = key_file.read()
...
np.save('encodings.npy', encodeListKnown, allow_pickle=True)
with open('classNames.csv', mode='w', newline='') as file:
